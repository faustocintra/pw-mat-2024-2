...
/*O método map() cria um NOVO VETOR, de tamanho IDÊNTICO ao do vetor original, em que cada elemento 
corresponde a uma transformação feita, no vetor de origem, pela função passada como parâmetro*/
