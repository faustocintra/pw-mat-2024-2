...
function PokemonInfo({pokemonName}) {
  ...
  //fetchPokemon() enviará pokemonName para o servidor remoto e aguardará o retorno de pokemonData.
  //Quando pokemnonData for retornado, atualiza a variavel de estado pokemon  com as informações 
  //contidas em pokemonData
