...
function Greeting({initialName = ''}) {
  ...
  const [name, setName] = React.useState(
    ...
    // Lazy initializer é uma técnica com a qual garantimos que valor
    // inicial de uma variável de estado seja 
    ...
    // que o valor inicial do estado seja retornado por uma função 
    // () => readLocalStorage()
  ...
  // Este useEffect() somente será executado quando a variável name mudar 
