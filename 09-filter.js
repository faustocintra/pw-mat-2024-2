/* Método filter() cria um novo vetor contendo apenas os elementos do vetor de origem que atendam
ao critério representada pela função passada como parâmetro */
...
console.log('Números negtivos:', negativos)
