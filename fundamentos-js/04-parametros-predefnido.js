...
*/
function calculaArea(base, altura, tipo = 'R') {
    switch (tipo) {
        case 'R': //retangulo
            return base * altura
            break;
...
console.log(`Área Triângulo 10 x 30: ${calculaArea(10, 30, 'T')}`)
console.log(`Área Elipse(circulo) 7,5 x 7,5: ${calculaArea(7.5, 7.5, 'E')}`)
console.log(`Área Retangulo 8 X 15: ${calculaArea(8, 15, 'R')}`)
console.log(`Área forma invalida 12 x 18: ${calculaArea(12, 18, 'W')}`)
...
*/
console.log(`Área Retangulo 8 X 15: ${calculaArea(8, 15)}`)
/*
