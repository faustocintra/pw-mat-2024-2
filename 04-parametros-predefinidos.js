/*
Função que calcula a área de uma figura geométrica plana, dados a base,
 a altura e o tipo de forma
*/
...
console.log(`Área forma inválida: ${calcArea(12, 18, "W")}`);

// Chamada à função usando apenas dois parâmetros.
// Como o terceiro parâmetro é predefinido com o valor 'R', a função
// entenderá que deverá fazer o cálculo de área para um retángulo
