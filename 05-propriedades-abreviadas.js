...
/*
Criando um objeto equivalente ao comentado acima, usando propriedades abreviadas.
Quando o nome das propriedades é idêntico ao das propriedades, nã é necessária a repetição
*/
...
Observe que os valores são mostrados, mas a saída não informa de quais variáveis provêm os valores
*/


console.log(x,y)

/*Saída melhorada? pássando um objeto formado pelas variáveis como propriedades abreviadas para console.log(),
conseguimos saber de onde vêm os valores
*/
console.log({x,y})